def test_log_in_with_valid_credentials(page):
    ...
    page.locator('[placeholder="Username"]').type('standard_user')
...
def test_login_with_invalid_credentials(page):
    page.goto('https://www.saucedemo.com')
    page.locator('[placeholder="Username"]').type('invalid_user')
    page.locator('[placeholder="Password"]').type('no_sauce')
    page.locator('#login-button').click()
    assert page.locator('[data-test="error"]').all()
